...
function setup() {
  ...
  c1 = new Rope(ball1.body,roof.body,-140);
	c2 = new Rope(ball2.body,roof.body,-70);
	c3 = new Rope(ball3.body,roof.body,0);
	c4 = new Rope(ball4.body,roof.body,70);
  c5 = new Rope(ball5.body,roof.body,140);
